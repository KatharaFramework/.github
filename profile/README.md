...
- [ROSE-T](https://github.com/KatharaFramework/roset): A tool that allows to ensure that router configurations are MANRS-compliant to the Network Operator Guidelines.
